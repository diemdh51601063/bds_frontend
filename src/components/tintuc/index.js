...
function TinTucComponent() {
  ...
  const [dientichsudung, setdientichsudung] = useState(0);
  ...
  const [hienthidanhmuc, sethienthidanhmuc] = useState('block');

  function checkPhanLoai(e, index, value) {
    var phanloai = e.target.options[e.target.selectedIndex].dataset.phanloai;
    if (phanloai == 2) {
      sethienthidanhmuc('none');
    } else {
      sethienthidanhmuc('block')
    }
  }

  const [hienthingaybatdau, sethienthingaybatdau] = useState(taoNgay(0));
  function doingaybatdau(e) {
    //alert(e.target.value)
    if (new Date(e.target.value) < new Date()) {
      alert('Ngày không hợp lệ');
    }
    else {
      sethienthingaybatdau(e.target.value);
    }
  }

  function taoNgay(giancach = 0, curr = new Date()) {
  ...
  useEffect(() => {
    setngayketthuc(taoNgay(parseInt(curGianCach), new Date(hienthingaybatdau)));
  }, [hienthingaybatdau])
  ...
  useEffect(() => {
    if (dientichsudung < 0) {
      setdientichsudung(Math.abs(dientichsudung));
    }
  }, [dientichsudung]);
  ...
  return (
    <>
      {
        decodeToken() == null && <Redirect to="/"></Redirect>
      }
      {
        (decodeToken() !== null && decodeToken().xacthuc == false) && <Redirect to="/nhapmaxacnhan"></Redirect>
      }
      {
        (decodeToken() !== null && decodeToken().xacthuc == true) &&
        <>
          <div class="main-body">
            <hr></hr>
                ...
                <Col md={9}>
                  <Form onSubmit={handleSubmit(addNewBds)} className="border border-light p-3">
                    ...
                    <Form className="border border-light p-5" >
                      ...
                      <Form.Row>
                        <Form.Group controlId="tieude" className='w-100'>
                          ...
                          <Form.Control ref={register({ required: true })} type="text" placeholder="Tiêu đề tin" name="tieude" />
                          {_.get("tieude.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng nhập tiêu đề tin</p>
                          )}
                        </Form.Group>
                      </Form.Row>
                      ...
                      <Form.Row>
                        ...
                        <Form.Group as={Col} controlId="hinhthuc" className='w-100'>
                          ...
                          <Form.Control as="select" name="id_hinhthuc" ref={register({ required: true })}>
                            <option value=''>--</option>
                            {
                          ...
                          {_.get("id_hinhthuc.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng chọn hình thức</p>
                          )}
                        </Form.Group>

                        <Form.Group as={Col} controlId="danhmuc" className='w-100'>
                          <Form.Label><b>Danh Mục</b></Form.Label>
                          <Form.Control onChange={checkPhanLoai} as="select" name="id_danhmucbds" ref={register({ required: true })}>
                            <option value=''>--</option>
                            {
                              listDanhmuc.length !== 0 && listDanhmuc.map(danhmuc => {
                                return (
                                  <option data-phanloai={`${danhmuc.id_phanloai}`} value={`${danhmuc.id}`} >{danhmuc.tendanhmuc}</option>
                                )
                              })
                            }
                          </Form.Control>
                          {_.get("id_danhmucbds.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng chọn danh mục</p>
                          )}
                        </Form.Group>
                      ...
                      <Form.Row>
                        <Form.Group as={Col} controlId="Thanhpho">
                          ...
                          <Form.Control as="select" ref={register({ required: true })} name="tinh_thanhpho" onChange={(e) => { showQuanHuyen(e.target.value) }}>
                            <option value=''>--</option>
                            {
                          ...
                          {_.get("tinh_thanhpho.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng chọn tỉnh/thành phố</p>
                          )}
                        </Form.Group>

                        <Form.Group as={Col} controlId="Quanhuyen">
                          <Form.Label><b>Quận/Huyện</b></Form.Label>
                          <Form.Control as="select" ref={register({ required: true })} name="quan_huyen" onChange={(e) => { showPhuongXa(e.target.value) }} >
                            {
                          ...
                          {_.get("quan_huyen.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng chọn quận/huyện</p>
                          )}
                        </Form.Group>
                      </Form.Row>
                      ...
                      <Form.Row>
                        <Form.Group as={Col} controlId="Phuongxa">
                          ...
                          <Form.Control as="select" ref={register({ required: true })} name="phuong_xa">
                            {
                          ...
                          {_.get("phuong_xa.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng chọn phường/xã</p>
                          )}
                        </Form.Group>

                        <Form.Group as={Col} controlId="diachi" >
                          <Form.Label><b>Địa Chỉ</b></Form.Label>
                          <Form.Control as="input" ref={register({ required: true })} name="diachi" >
                          </Form.Control>
                          {_.get("diachi.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng nhập địa chỉ</p>
                          )}
                        </Form.Group>
                      </Form.Row>
                      ...
                      <Form.Row>
                        ...
                        <Form.Group as={Col} controlId="dientichsudung" >
                          ...
                          <Form.Control type="number" as="input" ref={register} name="dientichsudung" onChange={(e) => { setdientichsudung(e.target.value) }} value={dientichsudung}>
                          </Form.Control>
                        </Form.Group>
                      </Form.Row>
                      ...
                      <Form.Row>
                        ...
                        <Form.Group as={Col} controlId="huong">
                          ...
                          <Form.Control as="select" ref={register({ required: true })} name="id_huong">
                            <option value=''>--</option>
                            {
                          ...
                          {_.get("id_huong.type", errors) === "required" && (
                            <p className="errorvalidate">Vui lòng chọn hướng</p>
                          )}
                        </Form.Group>

                        <Form.Group as={Col} controlId="giacca" >
                          <Form.Label><b>Gía cả</b></Form.Label>
                          <Form.Control type="number" as="input" ref={register({ min: 0.1 })} name="giaca" onChange={(e) => { setgiaca(e.target.value) }} value={giaca}>
                          </Form.Control>
                          {_.get("giaca.type", errors) === "min" && (
                            <p className="errorvalidate">Gía không được bằng 0</p>
                          )}
                        </Form.Group>
                      ...
                      <Form.Row>
                        ...
                        <Form.Group as={Col} controlId="hinhanh" className='w-100'>
                          ...
                          <Form.File onChange={hienthiListAnh} type="file" name="hinhdaidien" ref={register({ required: true })} multiple>
                          </Form.File>
                          {
                        ...
                        {_.get("hinhdaidien.type", errors) === "required" && (
                          <p className="errorvalidate">Vui lòng chọn hình ảnh</p>
                        )}
                      </Form.Row>
                    </Form>
                    <hr></hr>
                      ...
                      <Form.Row>
                        <Col md={8}>
                          <Form.Group controlId="mota" className='w-100'>
                            <Form.Control as="textarea" name="mota" rows="6" ref={register({ required: true })} />
                            {_.get("mota.type", errors) === "required" && (
                              <p className="errorvalidate">Vui lòng nhập mô tả</p>
                            )}
                          </Form.Group>
                        </Col>
                        <Col md={4}>
                    ...
                    <Form className="border border-light p-5" >
                      ...
                      <div id='sophong' style={{ display: hienthidanhmuc }}>
                        <Form.Row>
                    ...
                    <Form className="border border-light p-5" >
                      ...
                      <Form.Row>
                        ...
                        <Form.Group as={Col} id="motadichvu">
                          ...
                          <Form.Control value={hienthingaybatdau} onChange={doingaybatdau} type="date" name="ngaybatdau" ref={register} />
